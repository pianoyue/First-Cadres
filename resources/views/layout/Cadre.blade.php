    ...
    <header class="header black-bg">
        ...
        <div class="top-menu">
            <ul class="nav pull-right top-menu" >
                <li ><a class="logout" href="{{url('/cadre/logout') }}" >退出</a>
                </li>
            </ul>
        </div>
    </header>
    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <p class="centered"><a href="profile.html"><img src="{{asset("img/ui-zac.jpg")}}" class="img-circle" width="60"></a></p>
                <h5 class="centered">用户：{{auth('admin')->user()->cadre_trueName}}</h5>
                <li class="sub-menu">
                    <a href="{{ url('/cadre/comment') }}" >
