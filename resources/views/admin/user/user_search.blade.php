                    ...
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <div class="row box-header">
                                <div class="col-sm-6">
                                    <a class="btn btn-primary btn-sm"  href="{{url('/user')}}">返回</a>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <tr>
                                ...
                                <th><i class="fa fa-bookmark"></i> 县（市、区）</th>
                                <th><i class=" fa fa-edit"></i> 所属乡镇</th>
                                <th><i class=" fa fa-edit"></i> 帮扶村名称</th>
                                <th><i class=" fa fa-edit"></i> 用户操作</th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody>
